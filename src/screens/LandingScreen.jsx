const LandingScreen = () => {
    return (
        <section className="h-screen flex flex-col justify-center items-center px-8 md:flex-row-reverse md:justify-between  md:pl-8 md:gap-x-12 md:px-0 md:pl-8">
            <img
            ...
            <div className="text-center md:text-left lg:mr-8">
                <h1 className="text-5xl md:text-5xl font-serif">Discourse</h1>
                ...
                <button className="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-base rounded-lg">
                    Join Now
                </button>
                <p>
